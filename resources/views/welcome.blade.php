        ...
        <nav class="bg-white border-gray-200 py-2.5 dark:bg-gray-900">
            <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
                <a href="#" class="flex items-center">
                    <img src="./images/logo.svg" class="h-6 mr-3 sm:h-9" alt="Asesores-TI" />
                    <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">Asesores-TI</span>
                </a>
                ...
                <div class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1" id="mobile-menu-2">
                    <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                        ...
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Tutoriales</a>
                        </li>
                        <li>
                            <a href="#" class="block py-2 pl-3 pr-4 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-purple-700 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Testimonios</a>
                        </li>
                        <li>
    ...
    <footer class="bg-white dark:bg-gray-800">
        <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
            ...
            <div class="grid grid-cols-2 gap-8 md:grid-cols-3 lg:grid-cols-5">
                ...
                <div>
                    <h3 class="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">UdeGVirtual</h3>
                    <ul class="text-gray-500 dark:text-gray-400">
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Jose Antonio Fernandez Almaraz</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Francisco Javier Castorena Jara</a>
                        </li>
                        <li class="mb-4">
                            <a href="#" class="hover:underline">Rodrigo Adrian Cortes Infante</a>
                        </li>
            ...
            <div class="text-center">
                <a href="#" class="flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                    <img src="./images/logo.svg" class="h-6 mr-3 sm:h-9" alt="Asesores-TI Logo" />
                    Asesores-TI    
                </a>
                <span class="block text-sm text-center text-gray-500 dark:text-gray-400">© 2023 Asesores-TI™. Todos los Derechos Reservados. Hecho con <a href="https://laravel.com/" class="text-purple-600 hover:underline dark:text-purple-500">Laravel</a>, <a href="https://tailwindcss.com" class="text-purple-600 hover:underline dark:text-purple-500">Tailwind CSS</a> y <a href="https://livewire.laravel.com/" class="text-purple-600 hover:underline dark:text-purple-500">Livewire.</a>
                </span>
